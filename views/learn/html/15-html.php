<div>&lt;html&gt;</div><div>&lt;body&gt;</div><div><br></div><div><div><br></div><div><div style="font-family: monospace;">&lt;h1&gt;Chameleon&lt;/h1&gt;<br></div><div style="font-family: monospace;">&lt;p&gt;Chameleon adalah&nbsp;<span style="font-family: arial;">&lt;<input class='anwer-input-user answer0' data-answer='del' maxlength='3' size='3'>&gt;</span>WEB<span style="font-family: arial;">&lt;/<input class='anwer-input-user answer1' data-answer='del' maxlength='3' size='3'>&gt;</span>&nbsp;belajar pemrograman online.&lt;/p&gt;</div><div style="font-family: monospace;"></div><div style="font-family: monospace;">&lt;/body&gt;</div></div></div><div><br></div><div><input type='hidden' class='count-input' value='2'></div><div>&lt;/body&gt;</div><div>&lt;/html&gt;</div><div class="answer-alert"></div>
<style type="text/css">
	.answer-alert {
		position: fixed;
		width: 100%;
