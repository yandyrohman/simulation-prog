<div>&lt;html&gt;</div><div>&lt;body&gt;</div><div><input class='anwer-input-user answer0' data-answer='&lt;p&gt;Hello World!&lt;/p&gt;' maxlength='19' size='19'></div><div><input type='hidden' class='count-input' value='1'></div><div>&lt;/body&gt;</div><div>&lt;/html&gt;</div><div class="answer-alert"></div>
<style type="text/css">
	.answer-alert {
		position: fixed;
		width: 100%;
