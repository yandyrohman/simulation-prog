<div>&lt;html&gt;</div><div>&lt;body&gt;</div><div><br></div><div>&lt;img src="chameleooon.png"&nbsp; width="100" height="100"<input class='anwer-input-user answer0' data-answer='alt="chameleon.org"&gt;' maxlength='21' size='20'></div><div><input type='hidden' class='count-input' value='1'></div><div>&lt;/body&gt;</div><div>&lt;/html&gt;</div><div class="answer-alert"></div>
<style type="text/css">
	.answer-alert {
		position: fixed;
		width: 100%;
