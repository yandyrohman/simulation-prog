<div>&lt;html&gt;</div><div>&lt;body&gt;</div><div><input class='anwer-input-user answer0' data-answer='&lt;hr&gt;' maxlength='4' size='4'></div><div>&lt;h1&gt;Chameleon&lt;/h1&gt;<br></div><div>&lt;p&gt;Chameleon adalah WEB belajar pemrograman online.&lt;/p&gt;</div><div><input type='hidden' class='count-input' value='1'></div><div>&lt;/body&gt;</div><div>&lt;/html&gt;</div><div class="answer-alert"></div>
<style type="text/css">
	.answer-alert {
		position: fixed;
		width: 100%;
