<div>&lt;html&gt;</div><div>&lt;body&gt;</div><div><br></div><div>&lt;p <input class='anwer-input-user answer0' data-answer='title="chameleon"' maxlength='17' size='17'>&gt;Chameleon adalah WEB belajar pemrograman online.&lt;/p&gt;</div><div><input type='hidden' class='count-input' value='1'></div><div>&lt;/body&gt;</div><div>&lt;/html&gt;</div><div class="answer-alert"></div>
<style type="text/css">
	.answer-alert {
		position: fixed;
		width: 100%;
