<div><input class='anwer-input-user answer0' data-answer='UPDATE' maxlength='6' size='6'> Customer</div><div><input class='anwer-input-user answer1' data-answer='SET' maxlength='3' size='3'> City = 'Cianjur'</div><div><br></div><div><input type='hidden' class='count-input' value='2'></div><div class="answer-alert"></div>
<style type="text/css">
	.answer-alert {
		position: fixed;
		width: 100%;
