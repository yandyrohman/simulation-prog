<div><input class='anwer-input-user answer0' data-answer='DELETE FROM' maxlength='11' size='11'> Customer</div><div><input class='anwer-input-user answer1' data-answer='WHERE' maxlength='5' size='5'> Country = 'Indonesia';</div><div><br></div><div><input type='hidden' class='count-input' value='2'></div><div class="answer-alert"></div>
<style type="text/css">
	.answer-alert {
		position: fixed;
		width: 100%;
