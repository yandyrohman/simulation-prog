<input class='anwer-input-user answer0' data-answer='SELECT' maxlength='6' size='6'> <input class='anwer-input-user answer1' data-answer='DISTINCT' maxlength='8' size='8'> Country FROM Customer;<div><br></div><div><input type='hidden' class='count-input' value='2'></div><div class="answer-alert"></div>
<style type="text/css">
	.answer-alert {
		position: fixed;
		width: 100%;
