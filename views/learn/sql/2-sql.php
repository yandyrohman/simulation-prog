<input class='anwer-input-user answer0' data-answer='SELECT' maxlength='6' size='6'> <input class='anwer-input-user answer1' data-answer='City' maxlength='4' size='4'> <input class='anwer-input-user answer2' data-answer='FROM' maxlength='4' size='4'> Customer;<div><br></div><div><input type='hidden' class='count-input' value='3'></div><div class="answer-alert"></div>
<style type="text/css">
	.answer-alert {
		position: fixed;
		width: 100%;
