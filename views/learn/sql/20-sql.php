<div>SELECT * FROM Customer</div><div><input class='anwer-input-user answer0' data-answer='WHERE City LIKE "a%"' maxlength='20' size='20'>;</div><div><br></div><div><input type='hidden' class='count-input' value='1'></div><div class="answer-alert"></div>
<style type="text/css">
	.answer-alert {
		position: fixed;
		width: 100%;
