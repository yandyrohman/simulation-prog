SELECT * FROM Customers<div><input class='anwer-input-user answer0' data-answer='WHERE' maxlength='5' size='5'> <input class='anwer-input-user answer1' data-answer='City' maxlength='4' size='4'> = <input class='anwer-input-user answer2' data-answer='"Berlin"' maxlength='8' size='8'>;</div><div><br></div><div><input type='hidden' class='count-input' value='3'></div><div class="answer-alert"></div>
<style type="text/css">
	.answer-alert {
		position: fixed;
		width: 100%;
