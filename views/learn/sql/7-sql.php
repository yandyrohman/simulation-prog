SELECT * FROM Customers<br><div><input class='anwer-input-user answer0' data-answer='ORDER BY' maxlength='8' size='8'> <input class='anwer-input-user answer1' data-answer='City' maxlength='4' size='4'></div><div><br></div><div><input type='hidden' class='count-input' value='2'></div><div class="answer-alert"></div>
<style type="text/css">
	.answer-alert {
		position: fixed;
		width: 100%;
