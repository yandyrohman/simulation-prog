<input class='anwer-input-user answer0' data-answer='SELECT' maxlength='6' size='6'> * FROM Pelanggan;<div><br><div><input type='hidden' class='count-input' value='1'></div></div><div class="answer-alert"></div>
<style type="text/css">
	.answer-alert {
		position: fixed;
		width: 100%;
