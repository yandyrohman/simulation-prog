SELECT * FROM Customers<br><div><input class='anwer-input-user answer0' data-answer='WHERE' maxlength='5' size='5'> CustomerID <input class='anwer-input-user answer1' data-answer='=' maxlength='1' size='1'> <input class='anwer-input-user answer2' data-answer='18' maxlength='2' size='2'>;</div><div><br></div><div><input type='hidden' class='count-input' value='3'></div><div class="answer-alert"></div>
<style type="text/css">
	.answer-alert {
		position: fixed;
		width: 100%;
