<div>SELECT <input class='anwer-input-user answer0' data-answer='SUM(Price)' maxlength='10' size='10'></div><div>FROM Products;</div><div><br></div><div><input type='hidden' class='count-input' value='1'></div><div class="answer-alert"></div>
<style type="text/css">
	.answer-alert {
		position: fixed;
		width: 100%;
