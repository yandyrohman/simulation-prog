<div><div>&lt;!DOCTYPE html&gt;</div><div>&lt;html&gt;</div><div>&lt;head&gt;</div><div><br></div><div>&lt;/head&gt;</div><div>&lt;body&gt;</div><div><br></div><div>&lt;h1 style='<input class='anwer-input-user answer0' data-answer='width:300px;' maxlength='12' size='12'> <input class='anwer-input-user answer1' data-answer='margin: auto;' maxlength='13' size='13'> <input class='anwer-input-user answer2' data-answer='border: 1px solid red;' maxlength='22' size='22'>'&gt;Hai gan ...&lt;/h1&gt;</div><div><br></div><div>&lt;/body&gt;</div><div>&lt;/html&gt;</div></div><div><br></div><div><input type='hidden' class='count-input' value='3'></div><div class="answer-alert"></div>
<style type="text/css">
	.answer-alert {
		position: fixed;
		width: 100%;
