<div><div>&lt;!DOCTYPE html&gt;</div><div>&lt;html&gt;</div><div>&lt;head&gt;</div><div><br></div><div>&lt;/head&gt;</div><div>&lt;body&gt;</div><div><br></div><div>&lt;h1 style='<input class='anwer-input-user answer0' data-answer='color' maxlength='5' size='5'>:<input class='anwer-input-user answer1' data-answer='orange;' maxlength='7' size='7'>'&gt;This is a heading&lt;/h1&gt;</div><div><br></div><div>&lt;/body&gt;</div><div>&lt;/html&gt;</div></div><div><br></div><div><input type='hidden' class='count-input' value='2'></div><div class="answer-alert"></div>
<style type="text/css">
	.answer-alert {
		position: fixed;
		width: 100%;
