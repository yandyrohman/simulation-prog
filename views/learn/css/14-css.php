<div><div>&lt;!DOCTYPE html&gt;</div><div>&lt;html&gt;</div><div>&lt;head&gt;</div><div><br></div><div>&lt;/head&gt;</div><div>&lt;body&gt;</div><div><br></div><div>&lt;h1 style='<input class='anwer-input-user answer0' data-answer='max-width: 500px;' maxlength='17' size='17'> <input class='anwer-input-user answer1' data-answer='height: 100px;' maxlength='14' size='14'> <input class='anwer-input-user answer2' data-answer='background-color: powderblue;' maxlength='29' size='29'>'&gt;Menampilkan tinggi dan lebar maksimum&lt;/h1&gt;</div><div><br></div><div>&lt;/body&gt;</div><div>&lt;/html&gt;</div></div><div><br></div><div><input type='hidden' class='count-input' value='3'></div><div class="answer-alert"></div>
<style type="text/css">
	.answer-alert {
		position: fixed;
		width: 100%;
