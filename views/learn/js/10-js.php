<div>function myFunction() {</div><div>&nbsp; &nbsp;alert("Hello World!");</div><div>}</div><div><br></div><div><input class='anwer-input-user answer0' data-answer='myFunction()' maxlength='12' size='12'>;</div><div><br></div><div><input type='hidden' class='count-input' value='1'></div><div class="answer-alert"></div>
<style type="text/css">
	.answer-alert {
		position: fixed;
		width: 100%;
