<div>alert(5 <input class='anwer-input-user answer0' data-answer='/' maxlength='1' size='1'> 4);</div><div><br></div><div><input type='hidden' class='count-input' value='1'></div><div class="answer-alert"></div>
<style type="text/css">
	.answer-alert {
		position: fixed;
		width: 100%;
