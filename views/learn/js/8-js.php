<div>x = 10;</div><div>y = 5;</div><div>x <input class='anwer-input-user answer0' data-answer='+=' maxlength='2' size='2'> y;</div><div><br></div><div><input type='hidden' class='count-input' value='1'></div><div class="answer-alert"></div>
<style type="text/css">
	.answer-alert {
		position: fixed;
		width: 100%;
