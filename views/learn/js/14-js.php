<div>var person = {</div><div>&nbsp; firstName: 'John',</div><div>&nbsp; lastName: 'Doe'</div><div>};</div><div><br></div><div>alert(<input class='anwer-input-user answer0' data-answer='person.firstName' maxlength='16' size='16'>);</div><div><br></div><div><input type='hidden' class='count-input' value='1'></div><div class="answer-alert"></div>
<style type="text/css">
	.answer-alert {
		position: fixed;
		width: 100%;
