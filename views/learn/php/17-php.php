<div>&lt;?php</div><div><div>function myFunction($nama, $lnama) {</div><div>&nbsp; echo <input class='anwer-input-user answer0' data-answer='$nama' maxlength='5' size='5'>;</div><div>}</div></div><div>?&gt;</div><div><br></div><div><input type='hidden' class='count-input' value='1'></div><div class="answer-alert"></div>
<style type="text/css">
	.answer-alert {
		position: fixed;
		width: 100%;
