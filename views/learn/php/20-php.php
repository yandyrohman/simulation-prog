<div>&lt;?php</div><div><div><div>$umur = array('Ramadhan' =&gt; '17', 'Yandi' =&gt; '18', 'Asep' =&gt; '17');</div><div><input class='anwer-input-user answer0' data-answer='asort($umur);' maxlength='13' size='13'></div></div></div><div>?&gt;</div><div><br></div><div><input type='hidden' class='count-input' value='1'></div><div class="answer-alert"></div>
<style type="text/css">
	.answer-alert {
		position: fixed;
		width: 100%;
