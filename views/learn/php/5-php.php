<div><div>&lt;?php&nbsp;</div><div>$a = <input class='anwer-input-user answer0' data-answer=' 10.0291 ' maxlength='9' size='9'>;&nbsp;</div><div>?&gt;</div></div><div><br></div><div><input type='hidden' class='count-input' value='1'></div><div class="answer-alert"></div>
<style type="text/css">
	.answer-alert {
		position: fixed;
		width: 100%;
