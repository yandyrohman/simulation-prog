<div><div>&lt;?php</div><div><div><input class='anwer-input-user answer0' data-answer='function myFunction()' maxlength='21' size='21'> {</div><div>&nbsp; echo 'Hallo Word';</div><div>}</div></div><div>?&gt;</div></div><div><input type='hidden' class='count-input' value='1'></div><div class="answer-alert"></div>
<style type="text/css">
	.answer-alert {
		position: fixed;
		width: 100%;
