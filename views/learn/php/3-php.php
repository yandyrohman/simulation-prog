<div><div>&lt;?php&nbsp;</div><div><input class='anwer-input-user answer0' data-answer='print' maxlength='5' size='5'> = 'Hello world!';&nbsp;</div><div>?&gt;</div></div><div><br></div><div><input type='hidden' class='count-input' value='1'></div><div class="answer-alert"></div>
<style type="text/css">
	.answer-alert {
		position: fixed;
		width: 100%;
