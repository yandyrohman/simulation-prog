<div>&lt;?php</div><div><input class='anwer-input-user answer0' data-answer='echo' maxlength='4' size='4'> 'Hello world!';</div><div>?&gt;</div><div><br></div><div><input type='hidden' class='count-input' value='1'></div><div class="answer-alert"></div>
<style type="text/css">
	.answer-alert {
		position: fixed;
		width: 100%;
