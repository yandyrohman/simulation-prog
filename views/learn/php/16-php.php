<div>&lt;?php</div><div>function myFunction() {</div><div>&nbsp; echo 'Hai Gan';</div><div>}</div><div><br></div><div><br></div><div><input class='anwer-input-user answer0' data-answer='myFunction();' maxlength='13' size='13'></div><div>?&gt;</div><div><br></div><div><input type='hidden' class='count-input' value='1'></div><div class="answer-alert"></div>
<style type="text/css">
	.answer-alert {
		position: fixed;
		width: 100%;
